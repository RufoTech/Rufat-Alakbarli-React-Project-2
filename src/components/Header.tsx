...
import { FaClock, FaFacebook, FaTwitter, FaInstagram, FaLinkedin } from "react-icons/fa";
      ...
      <nav className='navbar'>
        <div className="container">
          ...
          <div className="social-media-icons">
            <a href="" className='text-decoration-none'><FaFacebook className='social-icon' /></a>
            <a href="" className='text-decoration-none'><FaTwitter className='social-icon' /></a>
            <a href="" className='text-decoration-none'><FaInstagram className='social-icon' /></a>
            <a href="" className='text-decoration-none'><FaLinkedin className='social-icon' /></a>
            <a href="" className='text-decoration-none'><FcGoogle /></a>
          </div>
        </div>
      </nav>

      <nav className={`navbar navbar-2 py-5 navbar-expand-lg ${isScrolled ? 'fixed-nav' : ''}`}>
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item rubik">
                <a className="nav-link text-light px-4" href="#"><CiSearch className='search-icon' /></a>
              </li>
            </ul>
          </div>
        </div>
